...
use App\Http\Controllers\Api\PdfReportSettingController;
...
use App\Http\Controllers\Api\TransitOrderController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/sales/{sale}/export-to-finance', [SaleController::class, 'exportToFinance'])->name('api.sales.exportToFinance');
