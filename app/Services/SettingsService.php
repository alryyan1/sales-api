...
class SettingsService
{
    ...
    public function managedKeysWithTypes(): array
    {
        return [
            ...
            'price_priority_source' => 'string', // 'product' or 'purchase'
        ];
    }
    ...
    public function defaultValues(): array
    {
        ...
        return [
            ...
            'price_priority_source' => $c['price_priority_source'] ?? 'product',
        ];
    }
    ...
    public function validationRules(): array
    {
        ...
        $rules['price_priority_source'] = ['nullable', 'string', Rule::in(['product', 'purchase'])];
        return $rules;
    }
